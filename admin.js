document.addEventListener('DOMContentLoaded', () => {
    ...
    const currentStaffCode = localStorage.getItem('currentStaffCode');
    ...
    logoutBtn.addEventListener('click', () => {
        if (confirm('¿Está seguro que desea cerrar sesión?')) {
            ...
            localStorage.removeItem('currentStaffCode');
            // NO limpiamos localStorage.clear() porque borraría los datos guardados
            window.location.href = 'index.html';
        }
    });
